<template>
  <div>
    <el-container>
      <el-header style="padding: 0px;display:flex;justify-content:space-between;align-items: center">
        <div style="display: inline">
          ...
          <el-button type="primary" size="mini" style="margin-left: 5px" icon="el-icon-search" @click="searchPatient">搜索
          </el-button>
        ...
        <div style="margin-left: 5px;margin-right: 20px;display: inline">
          <el-upload
            ...
            action="/patient/basic/importPatient"
          ...
          <el-button type="success" size="mini" @click="exportPatients"><i class="fa fa-lg fa-level-down"
                                                                       style="margin-right: 5px"></i>导出数据
          </el-button>
          <el-button type="primary" size="mini" icon="el-icon-plus"
                     @click="showAddPatientView">
            添加病人
          </el-button>
        </div>
      </el-header>
      <el-main style="padding-left: 0px;padding-top: 0px">
        <div>
          <transition name="slide-fade">
            <div
              ...
              <el-row>
                <el-col :span="5">
                  政治面貌:
                  <el-select v-model="patient.politicId" style="width: 130px" size="mini" placeholder="政治面貌">
                    <el-option
                ...
                <el-col :span="4">
                  民族:
                  <el-select v-model="patient.nationId" style="width: 130px" size="mini" placeholder="请选择民族">
                    <el-option
                ...
                <el-col :span="4">
                  职位:
                  <el-select v-model="patient.posId" style="width: 130px" size="mini" placeholder="请选择职位">
                    <el-option
                ...
                <el-col :span="4">
                  职称:
                  <el-select v-model="patient.jobLevelId" style="width: 130px" size="mini" placeholder="请选择职称">
                    <el-option
              ...
              <el-row style="margin-top: 10px">
                <el-col :span="5">
                  ...
                  <el-popover
                    ...
                    <div slot="reference"
                         ...
                         @click="showDepTree2" v-bind:style="{color: depTextColor}">{{patient.departmentName}}
                    </div>
                  </el-popover>
                </el-col>
                <el-col :span="10">
                ...
                <el-col :span="5" :offset="4">
                  ...
                  <el-button icon="el-icon-search" type="primary" size="mini" @click="searchPatient">搜索</el-button>
                </el-col>
              </el-row>
            </div>
          </transition>
          ...
          <div style="display: flex;justify-content: space-between;margin: 2px">
            <el-button type="danger" size="mini" v-if="patients.length>0" :disabled="multipleSelection.length==0"
                       @click="deleteManyPatients">批量删除
            </el-button>
            <el-pagination
              background
              :page-size="10"
    ...
    <el-form :model="patient" :rules="rules" ref="addPatientForm" style="margin: 0px;padding: 0px;">
      <div style="text-align: left">
        <el-dialog
            ...
            <el-col :span="7">
              <div>
                <el-form-item label="政治面貌:" prop="politicId">
                  <el-select v-model="patient.politicId" style="width: 200px" size="mini" placeholder="政治面貌">
                    <el-option
                      v-for="item in politics"
                      :key="item.id"
                      :label="item.name"
            ...
            <el-col :span="6">
              <div>
                <el-form-item label="民族:" prop="nationId">
                  <el-select v-model="patient.nationId" style="width: 150px" size="mini" placeholder="请选择民族">
                    <el-option
                      v-for="item in nations"
                      :key="item.id"
                      :label="item.name"
            ...
            <el-col :span="6">
              <div>
                <el-form-item label="电子邮箱:" prop="email">
                  <el-input prefix-icon="el-icon-message" v-model="patient.email" size="mini" style="width: 150px"
            ...
            <el-col :span="7">
              <div>
                <el-form-item label="联系地址:" prop="address">
                  <el-input prefix-icon="el-icon-edit" v-model="patient.address" size="mini" style="width: 200px"
            ...
            <el-col :span="6">
              <div>
                <el-form-item label="职位:" prop="posId">
                  <el-select v-model="patient.posId" style="width: 150px" size="mini" placeholder="请选择职位">
                    <el-option
                      v-for="item in positions"
                      :key="item.id"
                      :label="item.name"
            ...
            <el-col :span="5">
              <div>
                <el-form-item label="职称:" prop="jobLevelId">
                  <el-select v-model="patient.jobLevelId" style="width: 120px" size="mini" placeholder="请选择职称">
                    <el-option
                      v-for="item in joblevels"
                      :key="item.id"
                      :label="item.name"
            ...
            <el-col :span="7">
              <div>
                <el-form-item label="电话号码:" prop="phone">
                  <el-input prefix-icon="el-icon-phone" v-model="patient.phone" size="mini" style="width: 200px"
          ...
          <el-row>
            ...
            <el-col :span="5">
              <div>
                <el-form-item label="学历:" prop="tiptopDegree">
                  <el-select v-model="patient.tiptopDegree" style="width: 120px" size="mini" placeholder="最高学历">
                    <el-option
            ...
            <el-col :span="6">
              <div>
                <el-form-item label="所在医院:" prop="school">
                  <el-input prefix-icon="el-icon-edit" v-model="patient.school" size="mini" style="width: 150px"
                            placeholder="所在医院"></el-input>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="7">
              <div>
                <el-form-item label="专业名称:" prop="specialty">
                  <el-input prefix-icon="el-icon-edit" v-model="patient.specialty" size="mini" style="width: 200px"
          ...
          <el-row>
            ...
            <el-col :span="6">
              <div>
                <el-form-item label="会诊日期:" prop="conversionTime">
                  <el-date-picker
    ...
    <el-button size="mini" type="primary" @click="addPatient('addPatientForm')">确 定</el-button>
  </span>
        </el-dialog>
      </div>
    </el-form>
...
<script>
  export default {
    ...
    methods: {
      ...
      exportPatients() {
        window.open("/patient/basic/exportPatient", "_parent");
      },
      cancelSearch() {
        this.advanceSearchViewVisible = false;
        this.emptyPatientData();
        this.beginDateScope = '';
        this.loadPatients();
      },
      ...
      doDelete(ids) {
        ...
        var _this = this;
        this.deleteRequest("/patient/basic/patient/" + ids).then(resp => {
      ...
      loadPatients() {
        var _this = this;
        this.tableLoading = true;
        this.getRequest("/patient/basic/patient?page=" + this.currentPage + "&size=10&keywords=" + this.keywords + "&politicId=" + this.patient.politicId + "&nationId=" + this.patient.nationId + "&posId=" + this.patient.posId + "&jobLevelId=" + this.patient.jobLevelId + "&engageForm=" + this.patient.engageForm + "&departmentId=" + this.patient.departmentId + "&beginDateScope=" + this.beginDateScope).then(resp => {
          this.tableLoading = false;
          if (resp && resp.status == 200) {
            var data = resp.data;
            _this.patients = data.patients;
            _this.totalCount = data.count;
//            _this.emptyPatientData();
          }
        })
      },
      addPatient(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            if (this.patient.id) {
              //更新
              this.tableLoading = true;
              this.putRequest("/patient/basic/patient", this.patient).then(resp => {
                _this.tableLoading = false;
                if (resp && resp.status == 200) {
                  var data = resp.data;
              ...
              //添加
              this.tableLoading = true;
              this.postRequest("/patient/basic/patient", this.patient).then(resp => {
                _this.tableLoading = false;
                if (resp && resp.status == 200) {
                  var data = resp.data;
      ...
      showEditPatientView(row) {
        ...
        this.patient.beginContract = this.formatDate(row.beginContract);
        this.patient.endContract = this.formatDate(row.endContract);
        this.patient.beginDate = this.formatDate(row.beginDate);
        this.patient.nationId = row.nation.id;
        this.patient.politicId = row.politicsStatus.id;
        this.patient.departmentId = row.department.id;
        this.patient.departmentName = row.department.name;
        this.patient.jobLevelId = row.jobLevel.id;
        this.patient.posId = row.position.id;

       delete this.patient.salary;
        delete this.patient.workAge;
        delete this.patient.notWorkDate;
